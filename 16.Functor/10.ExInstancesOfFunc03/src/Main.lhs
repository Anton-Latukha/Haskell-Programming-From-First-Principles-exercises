...
main = do
  quickCheck (prop_functorId' ∷ Two String Integer → Bool)
  quickCheck (prop_functorId' ∷ Two String String → Bool)
  quickCheck (prop_functorCompose' ∷ Two String String → Fun String Integer → Fun Integer String → Bool)
\end{code}
